package pe.gob.pj.eje.penal.ms_motor_reglas.domain.repository;
...
public interface ReglaDroolsRepository extends JpaRepository<ReglaDrools, Long> {
    @Query("SELECT new pe.gob.pj.eje.penal.ms_motor_reglas.application.dto.response.ComboDTOResponse(" +
            "x.id, " +
     ...
     */
    @Query("SELECT new pe.gob.pj.eje.penal.ms_motor_reglas.application.dto.response.ReglaDroolsDTOResponse(" +
            "r.id, " +
            "r.nombre," +
            "r.descripcion, " +
            "r.documento, " +
